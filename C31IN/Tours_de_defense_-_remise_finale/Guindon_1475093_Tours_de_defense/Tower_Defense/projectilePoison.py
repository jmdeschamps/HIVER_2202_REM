...
class ProjectilePoison(Projectile):
    def __init__(self, tour_source, tour_x, tour_y, cible, parent, degats_additionnels):
        ...
        self.vitesse = 10
        self.degat = 1
        self.degats_additionnels = degats_additionnels
    ...
    def parcours_la_zone_de_jeu(self):
        ...
        if self.cible.pos_x - 3 < self.x < self.cible.pos_x + 3 or self.cible.pos_y - 3 < self.y < self.cible.pos_y + 3:
            ...
            self.cible.vitesse = 2
            self.cible.degat_poison = self.degats_additionnels
            return self.cible
        return None
