    ...
    def retour_batiment_mere(self):
        ...
        if reponse == "rendu":
            if self.cible:
                ...
                if self.parent.ressources["soul"] >= 220:   #SS
                    self.parent.win()
                    print("WIN")
...
class Joueur():
    ...
    ressources = {"Azteque" : {"soul": 999,
                              ...
                              "roche": 200,
                              "aureus": 200,
                              "ouvrier": 0, # SS Bâtiments ajoutés dans les ressources pour le compte pendant l'environnement test
                              "soldat": 0, # SS
                              "archer": 0, # SS
                              "chevalier": 0, # SS
                              "druide": 0, # SS
...
class Partie():
    ...
    def __init__(self, parent, mondict):
        ...
        self.on_off = 0  ##Alex? pour le choix de retour de l'ouvrier\ pas tres clair comme variable
